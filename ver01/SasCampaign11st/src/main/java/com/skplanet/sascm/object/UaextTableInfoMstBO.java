...
public class UaextTableInfoMstBO {
	...
	public String getRecycle_period() {
		return recycle_period;
	}

	public void setRecycle_period(String recycle_period) {
		this.recycle_period = recycle_period;
	}
